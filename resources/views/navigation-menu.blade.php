<nav x-data="{ open: false }" class="bg-white dark:bg-dark-800 border-b border-gray-100 ">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            @endcan
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link href="{{ route('suscripciones') }}" :active="request()->routeIs('suscripciones')">
                        {{ __('Suscripciones') }}
                    </x-nav-link>
                </div>
                @endcan

                @can('admin.historialSuscripciones')
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link href="{{ route('historialSuscripciones') }}" :active="request()->routeIs('historialSuscripciones')">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link href="{{ route('transacciones') }}" :active="request()->routeIs('transacciones')">
                        {{ __('Transacciones') }}
                    </x-nav-link>
                </div>
                @endcan         
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link href="{{ route('suscripciones') }}" :active="request()->routeIs('suscripciones')">
                {{ __('Suscripciones') }}
            </x-responsive-nav-link>
