...
<?php $component = App\View\Components\Forms\SearchBar::resolve(['placeholder' => 'Buscar transacciones...'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
    ...
    <div class="w-full overflow-x-auto rounded-sm mt-10">
        <table class="w-full text-md text-left">
            ...
            <tbody class="bg-white">
                <!--[if BLOCK]><![endif]--><?php if($transacciones->isEmpty()): ?>
                    <tr>
                ...
                <?php else: ?>
                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $transacciones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $transaccion): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="border-b even:bg-gray-50 hover:bg-gray-100">
                            <td class="px-4 py-2"><?php echo e($transaccion->user->full_name); ?></td>
                            <td class="px-4 py-2"><?php echo e($transaccion->membresia->nombre); ?></td>
                            <td class="px-4 py-2">$ <?php echo e($transaccion->monto); ?></td>
                            <td class="px-4 py-2">
                               <?php echo e(\Carbon\Carbon::parse($transaccion->fecha_pago)->isoFormat(' DD-MMMM-YYYY')); ?>
...
<?php /**PATH C:\xampp\htdocs\gymUpdate\resources\views/livewire/admin/suscripciones/tabla-transacciones-component.blade.php ENDPATH**/ ?>