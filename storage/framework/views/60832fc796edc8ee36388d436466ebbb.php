<div>
    <div class="w-full space-y-4">
        <?php if($suscripciones->count() > 0): ?>
            <?php $__currentLoopData = $suscripciones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $suscripcion): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div
                            ...
                            <ul class="space-y-3">
                                ...
                                <li class="flex items-center justify-end mt-4">
                                    <a href=""
                                        ...
                                        aria-label="Ver detalles de la suscripción de <?php echo e($suscripcion->user_id ?? 'miembro desconocido'); ?>">
