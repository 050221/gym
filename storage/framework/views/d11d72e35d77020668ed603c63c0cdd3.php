...
$__html = app('livewire')->mount($__name, $__params, 'lw-146150545-0', $__slots ?? [], get_defined_vars());
    ...
    <div class="w-full overflow-x-auto rounded-sm mt-10">
        <table class="w-full text-md text-left">
            ...
            <tbody class="bg-white">
                ...
                <?php else: ?>
                    <?php $__currentLoopData = $membresias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $membresia): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
$__html = app('livewire')->mount($__name, $__params, 'lw-146150545-1', $__slots ?? [], get_defined_vars());
...
<?php /**PATH C:\xampp\htdocs\gymUpdate\resources\views\livewire\admin\membresias\tabla-membresias-component.blade.php ENDPATH**/ ?>