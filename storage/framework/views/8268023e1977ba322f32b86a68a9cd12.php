...
$__html = app('livewire')->mount($__name, $__params, 'lw-1121203511-0', $__slots ?? [], get_defined_vars());
...
?>
    ...
    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('user.dashboard')): ?>
        <div class="flex flex-wrap">
            ...
            <?php if($suscripcion !== null && $suscripcion->count() > 0): ?>
        ...
        <div class="flex flex-wrap mt-12">
            ...
            <div class="table-responsive w-full">
                <table class="table table-hover mt-10 ">
                    ...
                    <tbody>
                        <?php if($historialSuscripciones->isEmpty()): ?>
                            <tr>
                                <td colspan="12">
                        ...
                        <?php else: ?>
                            <?php $__currentLoopData = $historialSuscripciones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $historialSuscripcion): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
