...
<?php endif; ?>
<?php $component->withAttributes(['required' => true,'autocomplete' => 'new-password']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                <?php if (isset($component)) { $__componentOriginalb8d293f9d75cb9660f36958154e74cee = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalb8d293f9d75cb9660f36958154e74cee = $attributes; } ?>
<?php $component = App\View\Components\InputPassword::resolve(['id' => 'password_confirmation','name' => 'password_confirmation','placeholder' => ''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('input-password'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\gymUpdate\resources\views\auth\reset-password.blade.php ENDPATH**/ ?>